...
// Enums
  enum MATHIFY_TOKEN_TYPE : char {
    ...
    // Unary Operators
    MATHIFY_TOKEN_TYPE_BITWISE_NOT = 30,
    MATHIFY_TOKEN_TYPE_LOGICAL_NOT = 31,
    MATHIFY_TOKEN_TYPE_POSTFIX_ADD = 32,
    MATHIFY_TOKEN_TYPE_POSTFIX_SUB = 33,

    // Special Arithmetic
    MATHIFY_TOKEN_TYPE_POWER = 34,

    // Control Flow
    MATHIFY_TOKEN_TYPE_LPAREN = 100,
    MATHIFY_TOKEN_TYPE_RPAREN = 101,

    // Non Arithmetic Unary Operators 
    MATHIFY_TOKEN_TYPE_TYPE_CAST = 107,
    MATHIFY_TOKEN_TYPE_DEREFENCE = 108,
    MATHIFY_TOKEN_TYPE_ADDRESS_OF = 109,
